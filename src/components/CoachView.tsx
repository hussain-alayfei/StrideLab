        ...
        {activeSubView === 'dashboard' && (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
              <div>
                <h1 className="text-4xl font-light text-stone-950 tracking-tight mb-2 italic font-serif">مركز القيادة (Coach Control)</h1>
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-stone-600 leading-relaxed font-light mb-6">
                        {alert.description} <strong className="text-red-800 font-semibold">توصية الذكاء الاصطناعي:</strong> تقليص مسافة الجري الطويل المجدول في نهاية الأسبوع بمقدار ٤ كم فورياً لتجنب تمزق العضلة الخلفية.
                      </p>
        ...
        {activeSubView === 'all_athletes' && (
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h1 className="text-3xl font-light text-stone-950 tracking-tight italic font-serif">ملفات العدائين والقائمة التدريبية</h1>
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-stone-950/40 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="bg-white border border-stone-200 shadow-2xl max-w-md w-full p-8 rounded-sm space-y-6 relative">
            ...
            <div>
              <h3 className="text-xl font-light text-stone-900 font-serif">إضافة لاعب جديد يدوياً للتدريب</h3>
